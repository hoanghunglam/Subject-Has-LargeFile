...
(function (app) {
    ...
    app.controller('awayDispatchListController', awayDispatchListController);
    // khởi tạo tự động các đối tượng service , và inject vào trong hàm productCategoryListController
    awayDispatchListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', 'authData'];

    function awayDispatchListController($scope, apiService, notificationService, $ngBootbox, authData) {
