...
(function (app) {
    app.controller('arrivedDispatchEditController', arrivedDispatchEditController);

    arrivedDispatchEditController.$inject = ['$scope', 'notificationService', 'apiService', '$state', '$stateParams', 'authData']

    function arrivedDispatchEditController($scope, notificationService, apiService, $state, $stateParams, authData) {
