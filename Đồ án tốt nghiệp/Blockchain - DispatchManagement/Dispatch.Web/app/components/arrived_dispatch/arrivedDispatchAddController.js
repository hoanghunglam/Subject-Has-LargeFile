...
(function (app) {
    'use strict';
    app.controller('arrivedDispatchAddController', arrivedDispatchAddController);
    // $state đối tượng  của ui-router để điều hướng 
    arrivedDispatchAddController.$inject = ['$scope', 'apiService', 'notificationService', '$state', 'authData'];

    function arrivedDispatchAddController($scope, apiService, notificationService, $state, authData) {
        $scope.dispatch = {
