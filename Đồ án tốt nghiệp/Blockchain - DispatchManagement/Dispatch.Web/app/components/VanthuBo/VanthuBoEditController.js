...
(function (app) {
    app.controller('VanthuBoEditController', VanthuBoEditController);

    VanthuBoEditController.$inject = ['$scope', 'notificationService', 'apiService', '$state', '$stateParams', 'authData']

    function VanthuBoEditController($scope, notificationService, apiService, $state, $stateParams, authData) {
        ...
        function LoadParticipantDetail() {
            apiService.getBlock('http://' + hostLam + ':3000/api/org.dispatch.VanThuCuaBo/' + $stateParams.id, {
                headers: {
        ...
        function UpdateParticipant() {
            apiService.putBlock('http://' + hostLam + ':3000/api/org.dispatch.VanThuCuaBo/' + $scope.participantId,
                $scope.participant, {
                    headers: {
                        'X-Access-Token': access_tokens
                    }
